...
export async function loadApp(name, hash, appURL) {
  ...
  if (hash === true) singleSpa.registerApplication(name, () => SystemJS.import(appURL), () => () => true, customProps)
  else singleSpa.registerApplication(name, () => SystemJS.import(appURL), hashPrefix(hash), customProps)
}